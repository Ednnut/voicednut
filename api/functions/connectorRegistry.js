...
const CONNECTOR_REGISTRY = Object.freeze({
  ...
  email_send_followup: {
    id: "business_sendgrid_followup",
    class: "side_effect",
    risk_class: "medium",
    capability_tags: ["email", "sendgrid", "follow_up", "business_ops"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "business_ops" },
    approval: { required: true, mode: "explicit" },
  },
  ...
  payment_connector_health: {
    id: "billing_payment_connector_health",
    class: "read",
    risk_class: "medium",
    capability_tags: ["payment", "billing", "business_ops", "audit"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "payment" },
    approval: { required: false, mode: "none" },
  },
  payment_connector_policy_evaluate: {
    id: "billing_payment_connector_policy",
    class: "read",
    risk_class: "medium",
    capability_tags: ["payment", "billing", "business_ops", "audit"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "payment" },
  ...
  payment_retry_link_generate: {
    id: "billing_payment_retry_link",
    class: "side_effect",
    risk_class: "high",
    capability_tags: ["payment", "billing", "business_ops", "risk"],
    default_policy: { timeout_ms: 14000, retry_limit: 0, circuit_group: "payment" },
    approval: { required: true, mode: "explicit" },
  },
  invoice_create: {
  ...
  payment_session_history: {
    id: "billing_payment_session_history",
    class: "read",
    risk_class: "medium",
    capability_tags: ["payment", "billing", "business_ops", "audit"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "payment" },
  ...
  payment_failure_summary: {
    id: "billing_payment_failure_summary",
    class: "read",
    risk_class: "medium",
    capability_tags: ["payment", "billing", "business_ops", "audit", "risk"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "payment" },
    approval: { required: false, mode: "none" },
  },
  customer_payment_profile: {
    id: "billing_customer_payment_profile",
    class: "read",
    risk_class: "medium",
    capability_tags: ["payment", "billing", "business_ops", "audit"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "payment" },
  ...
  paypal_agent_toolkit_manifest: {
    id: "billing_paypal_agent_toolkit_manifest",
    class: "read",
    risk_class: "medium",
    capability_tags: ["payment", "billing", "business_ops", "audit"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "payment" },
  ...
  paypal_agent_toolkit_execute: {
    id: "billing_paypal_agent_toolkit_execute",
    class: "read",
    risk_class: "medium",
    capability_tags: ["payment", "billing", "business_ops", "audit"],
    default_policy: { timeout_ms: 10000, retry_limit: 0, circuit_group: "payment" },
